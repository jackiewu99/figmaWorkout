...
export default function FeaturesText2x2(props) {
  const { workout2x2, overrides, ...rest } = props;
  return (
    <Flex
      gap="10px"
      direction="column"
          ...
          >
            ...
            >
              <Image
                ...
                objectFit="cover"
                src={workout2x2?.demo}
                {...getOverrideProps(overrides, "image34602665")}
              ></Image>
            </Flex>
            <Flex
              gap="8px"
            ...
            >
              <Image
                ...
                padding="0px 0px 0px 0px"
                objectFit="cover"
                src={workout2x2?.demo2}
                {...getOverrideProps(overrides, "image34602666")}
              ></Image>
            </Flex>
          </Flex>
        </Flex>
      ...
      >
        ...
        >
          ...
          <Text
            ...
            padding="0px 0px 0px 0px"
            whiteSpace="pre-wrap"
            children={workout2x2?.rep}
            {...getOverrideProps(overrides, "sadadadadsadadadasdsadasad")}
          ></Text>
        </Flex>
        <Flex
          gap="8px"
        ...
        >
          ...
          <Text
            ...
            padding="0px 0px 0px 0px"
            whiteSpace="pre-wrap"
            children={workout2x2?.rep2}
            {...getOverrideProps(overrides, "dasdsadadsadadadsa")}
          ></Text>
        </Flex>
      </Flex>
    </Flex>
